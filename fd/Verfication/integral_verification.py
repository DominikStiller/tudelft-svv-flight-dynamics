...
if test == "pulse_elevator":
    ...
    aero_params = AerodynamicParameters(C_L_alpha=0.08305247637936027, C_D_0=0.023439123324849084, C_m_alpha=-0.009693672475678806, C_m_delta=-0.023354208039387547, e=1.0713238368125688)
    ...
    flight_test = FlightTest("data/B24")
    aero_params = AerodynamicParameters(C_L_alpha=0.08305247637936027, C_D_0=0.023439123324849084,
                                        C_m_alpha=-0.009693672475678806, C_m_delta=-0.023354208039387547,
